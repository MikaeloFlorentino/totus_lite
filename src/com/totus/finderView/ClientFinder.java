 ...
 * @author mikaelo
 */
public class ClientFinder  extends View <Client> {
    ...
    /**
     * Creates new form ClientFinder
     */
    public ClientFinder(java.awt.Frame parent, boolean modal) {
        super("Busqueda - Cliente", 653, 299, parent, modal);
        initComponents();
        clientController = new ClientController();
        client = new Client();
        model = (DefaultTableModel) jTFClient.getModel();
        select = 0;
        model.setNumRows(0);
        listClient = null;
    }
    ...
    private void initComponents() {
        ...
        jTFClient = new javax.swing.JTable();
        ...
        jTFClient.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jTFClient);
    ...
    private void jBFBuscarPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBFBuscarPActionPerformed
        ...
        listClient = clientController.getListByName(client);
        if(listClient.size()>0){
            for(Client p: listClient){
    ...
    private javax.swing.JTable jTFClient;
