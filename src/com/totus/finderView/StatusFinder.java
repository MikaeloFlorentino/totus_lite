 ...
 * @author mikaelo
 */
public class StatusFinder  extends View <Status> {
    ...
    /**
     * Creates new form StatusFinder
     */
    public StatusFinder(java.awt.Frame parent, boolean modal) {
        super("Busqueda - Status", 653, 299, parent, modal);
        initComponents();
        statusController = new StatusController();
        status = new Status();
        model = (DefaultTableModel) jTFStatus.getModel();
        select = 0;
        model.setNumRows(0);
        listStatus = null;
    }
    ...
    private void initComponents() {
        ...
        jTFStatus = new javax.swing.JTable();
        ...
        jTFStatus.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jTFStatus);
    ...
    private void jBFBuscarPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBFBuscarPActionPerformed
        ...
        listStatus = statusController.getListByName(status);
        if(listStatus.size()>0){
            for(Status p: listStatus){
    ...
    private javax.swing.JTable jTFStatus;
