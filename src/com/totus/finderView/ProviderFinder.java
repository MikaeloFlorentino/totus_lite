 ...
 * @author mikaelo
 */
public class ProviderFinder  extends View <Provider> {
     ...
     */
    public ProviderFinder(java.awt.Frame parent, boolean modal) {
        super("Busqueda - Proveedr", 653, 299, parent, modal);
        initComponents();
        providerController = new ProviderController();
        provider = new Provider();
        model = (DefaultTableModel) jTFProvider.getModel();
        select = 0;
        model.setNumRows(0);
        listProvider = null;
    }
    ...
    private void initComponents() {
        ...
        jTFProvider = new javax.swing.JTable();
        ...
        jTFProvider.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jTFProvider);
    ...
    private void jBFBuscarPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBFBuscarPActionPerformed
        model.setNumRows(0);
        provider.setNombre(jTFNombre.getText());
        listProvider = providerController.getListByName(provider);
        if(listProvider.size()>0){
            for(Provider p: listProvider){
                model.addRow(new Object[]{p.getId(), p.getNombre(), p.getCalle()});
            }
    ...
    private javax.swing.JTable jTFProvider;
