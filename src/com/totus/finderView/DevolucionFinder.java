 ...
 * @author mikaelo
 */
public class DevolucionFinder  extends View <Devolucion> {

    DevolucionController devolucionController;
    Devolucion devolucion;
    DefaultTableModel model;
    private int select;
    List<Devolucion> listDevolucion;
    /**
     * Creates new form DevolucionFinder
     */
    public DevolucionFinder(java.awt.Frame parent, boolean modal) {
        super("Busqueda - Devolucion", 653, 299, parent, modal);
        initComponents();
        devolucionController = new DevolucionController();
        devolucion = new Devolucion();
        model = (DefaultTableModel) jTFDevolucion.getModel();
        select = 0;
        model.setNumRows(0);
        listDevolucion = null;
    }
    ...
    private void initComponents() {
        ...
        jTFDevolucion = new javax.swing.JTable();
        ...
        jLabel1.setText("Mensaje de Venta ");

        jTFDevolucion.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "identificador", "Nombre Provedor", "Dirección Provedor"
            }
        ) {
        ...
        jScrollPane1.setViewportView(jTFDevolucion);
    ...
    private void jBFBuscarPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBFBuscarPActionPerformed
        model.setNumRows(0);
        devolucion.setMessage(jTFNombre.getText());
        listDevolucion = devolucionController.getListByUserMessage(devolucion);
        if(listDevolucion.size()>0){
            for(Devolucion p: listDevolucion){
                model.addRow(new Object[]{p.getId(), p.getMessage(), p.getFecha()});
            }
    ...
    private javax.swing.JTable jTFDevolucion;
