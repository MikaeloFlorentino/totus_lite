 ...
 * @author mikaelo
 */
public class ReportQuirofanoListView extends View <Quirofano> {

    Report report;
    
    public ReportQuirofanoListView(java.awt.Frame parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Lisado de Quirofanos");
    ...
    private void JBImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBImprimirActionPerformed
        try{
            ...
            report.getReport(Constant.REPORT_QUIROFANO_LIST, parameters);
        } catch (Exception ex) {
