 ...
 * @author mikaelo
 */
public class ReportQuirofanoSumaryView extends View <Quirofano> {

    Report report;
    
    public ReportQuirofanoSumaryView(java.awt.Frame parent, boolean modal) {
        super("Reporte - Quirofano Resumen", 603, 100, parent, false);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Resumen de Quirofanos");
    ...
    private void JBImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBImprimirActionPerformed
        try{
            ...
            report.getReport(Constant.REPORT_QUIROFANO_SUMARY, parameters);
        } catch (Exception ex) {
